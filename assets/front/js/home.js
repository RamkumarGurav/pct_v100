...
$("#testimonial_videos").owlCarousel({
autoplay: false,
loop: false,
margin: 20,
 /*
...
function setOwlCarouselWithoutLoop(id,d_items = 4) {
  jQuery("#"+id).owlCarousel({
         autoplay: true,
         rewind: true, /* use rewind if you don't want loop */
         margin: 20,
...
function getProducts(displayClass , classOffset , limit)
{
	...
	$.ajax({
	   ...
	   success : function(result){
    	...
    	if(displayClass == 'slider_best_sellers_pd_page')
    	{ }else if (displayClass == 'recent_viewed_products') {
        setOwlCarouselWithoutLoop(displayClass , d_items);
      }
    	else{
...
if($("*").hasClass("recent_viewed_products"))
{
	getProducts('recent_viewed_products' , 'sr2' , 10);
}
