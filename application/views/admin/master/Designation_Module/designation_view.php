            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?=$designation_master_data->designation_name?></h3>
                        <div class="float-right">
							...
							?>
							<a href="<?=MAINSITE_Admin.$user_access->class_name?>/designation-edit/<?=$designation_master_data->designation_id?>"> 
                            ...
                            <table id="" class="table table-bordered table-hover myviewtable responsiveTableNewDesign">
                                <tbody>
									<tr>
										...
										<?=$designation_master_data->designation_id?></td>
										<td >
										<strong class="full">Designation</strong>
										<?=$designation_master_data->designation_name?></td>
										<td>
										<strong class="full">Added On</strong>
										<?=date("d-m-Y h:i:s A" , strtotime($designation_master_data->added_on))?></td>
										<td >
										<strong class="full">Added By</strong>
										<?=$designation_master_data->added_by_name?></td>
										<td >
										<strong class="full">Updated On</strong>
										<? if(!empty($designation_master_data->updated_on)){echo date("d-m-Y h:i:s A" , strtotime($designation_master_data->updated_on));}else{echo "-";}?></td>
										<td >
										<strong class="full">Updated By</strong>
										<? if(!empty($designation_master_data->updated_by_name)){echo $designation_master_data->updated_by_name;}else{echo "-";}?></td>
										<td>
										<strong class="full">Status</strong>
										<? if($designation_master_data->status==1){ ?> Active <i class="fas fa-check btn-success btn-sm "></i>
