						...
						<div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='urm.user_role_name' <? if($field_name=='urm.user_role_name'){echo 'selected';} ?>>User Role Name</option>
								</select>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <? } ?>
                                        <td><a href="<?=MAINSITE_Admin.$user_access->class_name."/role-manager-view/".$urm->user_role_id?>"><?=$urm->user_role_name	?></a></td>
