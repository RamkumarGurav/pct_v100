						...
						<div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='urm.country_name' <? if($field_name=='urm.country_name'){echo 'selected';} ?>>Country</option>
									<option value='urm.country_short_name' <? if($field_name=='urm.country_short_name'){echo 'selected';} ?>>Country Short Name</option>
									<option value='urm.dial_code' <? if($field_name=='urm.dial_code'){echo 'selected';} ?>>Dial Code</option>
									<option value='urm.country_code' <? if($field_name=='urm.country_code'){echo 'selected';} ?>>Country Code</option>
								</select>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <? } ?>
                                        <td><a href="<?=MAINSITE_Admin.$user_access->class_name."/country-view/".$urm->country_id?>"><?=$urm->country_name	?></a></td>
