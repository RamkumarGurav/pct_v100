						...
						<div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='urm.name' <? if($field_name=='urm.name'){echo 'selected';} ?>>Coupon</option>
									<option value='urm.discount_value' <? if($field_name=='urm.discount_value'){echo 'selected';} ?>>Discount Value</option>
								</select>
