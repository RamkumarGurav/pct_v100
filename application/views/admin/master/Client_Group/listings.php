						...
						<div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='urm.group_name' <? if($field_name=='urm.group_name'){echo 'selected';} ?>>Group Name</option>
								</select>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <? } ?>
										<td><a href="<?=MAINSITE_Admin.$user_access->class_name."/view/".$urm->group_id?>"><?=$urm->group_name	?></a></td>
                                        <td><?=$urm->group_description?></td>
                                        <td><?=$urm->minimum_order_value?></td>
