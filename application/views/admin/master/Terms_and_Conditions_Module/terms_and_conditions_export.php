<?php
		...
		$filename = "Terms-and-Conditions-List-" . date('d-m-Y') . ".xls"; header("Content-Disposition: attachment; filename=\"$filename\""); 
...
<br />&nbsp;
                                    ...
                                    ?>
                                        <tr>
											...
											<td width="*"><? echo $row->terms_and_conditions_name;?></td>
