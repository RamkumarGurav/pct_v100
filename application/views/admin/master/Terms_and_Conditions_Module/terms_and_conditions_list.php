						...
						<div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='urm.terms_and_conditions_name' <? if($field_name=='urm.terms_and_conditions_name'){echo 'selected';} ?>>Terms and Conditions</option>
								</select>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <? } ?>
                                        <td><a href="<?=MAINSITE_Admin.$user_access->class_name."/terms-and-conditions-view/".$urm->terms_and_conditions_id?>"><?=$urm->terms_and_conditions_name	?></a></td>
