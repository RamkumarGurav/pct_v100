						...
						<div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='urm.tax_name' <? if($field_name=='urm.tax_name'){echo 'selected';} ?>>Tax</option>
									<option value='urm.tax_percentage' <? if($field_name=='urm.tax_percentage'){echo 'selected';} ?>>Tax Percentage</option>
								</select>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <? } ?>
                                        <td><a href="<?=MAINSITE_Admin.$user_access->class_name."/tax-view/".$urm->tax_id?>"><?=$urm->tax_name	?></a></td>
                                        <td><?=$urm->tax_percentage?></td>
