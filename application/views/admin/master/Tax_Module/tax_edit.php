            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
						...
						<? if(!empty($tax_data)){ ?>
						<li class="breadcrumb-item"><a href="<?=MAINSITE_Admin.$user_access->class_name."/tax_view/".$tax_id?>">View</a></li>
						<? } ?>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?=$tax_name?> <small><?=$record_action?></small></h3>
                    </div>
                    <!-- /.card-header -->
                    <?php 
                    ...
                    <div class="card-body">
							...
							<input type="hidden" name="redirect_type" id="redirect_type" value="" />
								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Tax <span style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
									<div class="col-sm-10">
									<input type="text" class="form-control form-control-sm" required id="tax_name" name="tax_name" value="<?=$tax_name?>" placeholder="Tax">
									
									</div>
								</div>
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Tax Percentage <span style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
									<div class="col-sm-10">
									<input type="number" class="form-control form-control-sm" required id="tax_percentage" name="tax_percentage" value="<?=$tax_percentage?>" placeholder="Tax Percentage">
