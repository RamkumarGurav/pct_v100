<?php
		...
		$filename = "Tax-List-" . date('d-m-Y') . ".xls"; header("Content-Disposition: attachment; filename=\"$filename\""); 
...
<br />&nbsp;
                                    ...
                                    ?>
                                        <tr>
											...
											<td width="*"><? echo $row->tax_name;?></td>
											<td width="*"><? echo $row->tax_percentage;?></td>
