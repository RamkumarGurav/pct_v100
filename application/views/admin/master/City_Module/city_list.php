						...
						<div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='urm.city_name' <? if($field_name=='urm.city_name'){echo 'selected';} ?>>City</option>
									<option value='urm.city_code' <? if($field_name=='urm.city_code'){echo 'selected';} ?>>City Code</option>
								</select>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <? } ?>
										<td><a href="<?=MAINSITE_Admin.$user_access->class_name."/city-view/".$urm->city_id?>"><?=$urm->city_name	?></a></td>
                                        <td><?=$urm->state_name?></td>
                                        <td><?=$urm->country_name?></td>
                                        <td><?=$urm->city_code?></td>
										<td>
                                            <? if($urm->is_display==1){ ?> <i class="fas fa-check btn-success btn-sm "></i>
