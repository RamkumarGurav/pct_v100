						...
						<div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='urm.unit_of_measurement_name' <? if($field_name=='urm.unit_of_measurement_name'){echo 'selected';} ?>>Unit Of Measurement</option>
								</select>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <? } ?>
                                        <td><a href="<?=MAINSITE_Admin.$user_access->class_name."/unit-of-measurement-view/".$urm->unit_of_measurement_id?>"><?=$urm->unit_of_measurement_name	?></a></td>
