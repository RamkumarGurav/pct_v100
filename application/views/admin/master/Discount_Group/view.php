            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?=$discount_group_data->discount_group_name?></h3>
                        <div class="float-right">
							...
							?>
							<a href="<?=MAINSITE_Admin.$user_access->class_name?>/edit/<?=$discount_group_data->discount_group_id?>"> 
                    ...
                    <div class="card-body">
                            ...
                            <div class="divTable">
                                ...
                                <div class="TableRow">
                                    ...
                                    <?=date("d-m-Y h:i:s A" , strtotime($discount_group_data->added_on))?>
                                    </div>
                                    <div class="table_col">
                                    <label class="label_content_br">Added By <span class="colen">:</span></label>
                                    <?=$discount_group_data->added_by_name?>
                                    </div>
                                    <div class="table_col">
                                    <label class="label_content_br">Updated On <span class="colen">:</span></label>
                                   <? if(!empty($discount_group_data->updated_on)){echo date("d-m-Y h:i:s A" , strtotime($discount_group_data->updated_on));}else{echo "-";}?>
                                    </div>
                                    <div class="table_col">
                                    <label class="label_content_br">Updated By <span class="colen">:</span></label>
                                    <? if(!empty($discount_group_data->updated_by_name)){echo $discount_group_data->updated_by_name;}else{echo "-";}?>
                                    </div>
                                    <div class="table_col">
                                    <label class="label_content_br">Status <span class="colen">:</span></label>
                                   <? if($discount_group_data->status==1){ ?> Active <i class="fas fa-check btn-success btn-sm "></i>
                            ...
                            <table id="" class="table table-bordered table-hover myviewtable" style="display:none;">                                
                                <tbody>                                    
									<tr>
										...
										<?=$discount_group_data->discount_group_id?></td>
										<td><strong class="full">Group Name</strong>
										<?=$discount_group_data->discount_group_name?></td>
										<td><strong class="full">Group Description</strong>
										<?=$discount_group_data->discount_group_description?></td>
										
									</tr>									
									<tr>
										<td><strong class="full">Added On</strong>
										<?=date("d-m-Y h:i:s A" , strtotime($discount_group_data->added_on))?></td>
										<td><strong class="full">Added By</strong>
										<?=$discount_group_data->added_by_name?></td>
										<td><strong class="full">Updated On</strong>
										<? if(!empty($discount_group_data->updated_on)){echo date("d-m-Y h:i:s A" , strtotime($discount_group_data->updated_on));}else{echo "-";}?></td>
										<td><strong class="full">Updated By</strong>
										<? if(!empty($discount_group_data->updated_by_name)){echo $discount_group_data->updated_by_name;}else{echo "-";}?></td>
