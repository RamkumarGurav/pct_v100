						...
						<div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='urm.discount_group_name' <? if($field_name=='urm.discount_group_name'){echo 'selected';} ?>>Group Name</option>
								</select>
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <? } ?>
										<td><a href="<?=MAINSITE_Admin.$user_access->class_name."/view/".$urm->discount_group_id?>"><?=$urm->discount_group_name	?></a></td>
                                        <td><?=$urm->discount_group_description?></td>
