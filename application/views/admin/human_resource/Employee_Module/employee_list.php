					  ...
					  <div class="card-body">
						<div class="row">
							<div class="col-md-3">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='aau.name' <? if($field_name=='aau.name'){echo 'selected';} ?>>Employee Name</option>
									<option value='aau.email' <? if($field_name=='aau.email'){echo 'selected';} ?>>Email</option>
									<option value='aau.mobile_no' <? if($field_name=='aau.mobile_no'){echo 'selected';} ?>>Mobile No.</option>
									<option value='aau.fax_no' <? if($field_name=='aau.fax_no'){echo 'selected';} ?>>Fax No.</option>
								</select>
                            ...
                            <div class="col-md-3">
								<div class="form-group">
									...
									<select type="text" class="form-control" id="user_role_id" name="user_role_id" style="width: 100%;">
										<option value="">Select Role</option>
										<? foreach($users_role_data as $urd){
											$selected="";
											if($urd->user_role_id == $user_role_id){$selected = "selected";}
											?>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<select type="text" class="form-control" id="designation_id" name="designation_id" style="width: 100%;" >
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									<label>Country</label>
									<select type="text" class="form-control"  id="country_id" name="country_id" onchange="getState(this.value ,0)" style="width: 100%;">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label>State</label>
									<select type="text" class="form-control"  id="state_id" name="state_id" style="width: 100%;" onchange="getCity(this.value ,0)">
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <? } ?>
										<td><a href="<?=MAINSITE_Admin.$user_access->class_name."/employee-view/".$urm->admin_user_id?>"><?=$urm->name	?></a></td>
                                        <td>
										<?
										if(!empty($urm->roles))
										{
                                        ...
                                        <td><?=$urm->designation_name?></td>
                                        <td><?=$urm->email?><br> <?=$urm->mobile_no?></td>
