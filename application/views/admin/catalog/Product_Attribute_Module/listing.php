...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-2 text-dark"><?=$page_module_name?> <small>List</small></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <table id="example1" class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <? } ?>
										<td><a href="<?=MAINSITE_Admin.$user_access->class_name."/view/".$urm->product_attribute_id?>"><?=$urm->name?></a></td>
                                        <td><?=$urm->attribute_name?></td>
                                        <td><?=$urm->condition_per_product?></td>
                                        <td><?=$urm->product_attribute_value_count?></td>
