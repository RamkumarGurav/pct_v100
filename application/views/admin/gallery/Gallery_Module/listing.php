						...
						<div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='aau.name' <? if($field_name=='aau.name'){echo 'selected';} ?>>Gallery Name</option>
								</select>
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <? } ?>
										<td><a href="<?=MAINSITE_Admin.$user_access->class_name."/view/".$urm->id?>"><?=$urm->name	?></a></td>
                                        <td><a href="<?=_uploaded_files_.'gallery/medium/'.$urm->image; ?>" target="_blank"><img src="<?=_uploaded_files_.'gallery/medium/'.$urm->image; ?>" alt="Active" width="120" height="60"  border="0" /></a></td>
