            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?=$working_method_data->working_method_id?></h3>
                        <div class="float-right">
                            <?php
								if($user_access->add_module==1)	{
								?>
								<a href="<?=MAINSITE_Admin.$user_access->class_name?>/working_method-edit">
							...
							?>
							<a href="<?=MAINSITE_Admin.$user_access->class_name?>/working_method-edit/<?=$working_method_data->working_method_id?>">
					...
					?>
                    <div class="card-body">
                        <form action="<?php echo MAINSITE_Admin."$user_access->class_name/userRole-doUpdateStatus";?>"
                            ...
                            <table id="" class="table table-bordered table-hover myviewtable responsiveTableNewDesign">
								...
								<tr>
										...
										<?=$working_method_data->working_method_id?></td>
										<td >
										<strong class="full">working_method Link</strong>
										<?=$working_method_data->working_method_link?></td>
										<td>
										<strong class="full">working_method Image</strong>
                    <img src="<?=MAINSITE.'assets/uploads/working_method/'.$working_method_data->working_method_image?>" alt="">
                                 ...
                                 <tr>
										...
										<?=$working_method_data->content?></td>
                                ...
                                <tbody>
                                 <tr>
										...
										<?=date("d-m-Y h:i:s A" , strtotime($working_method_data->added_on))?></td>
										<td>
										<strong class="full">Added By</strong>
										<?=$working_method_data->added_by_name?></td>
										<td>
										<strong class="full">Updated On</strong>
										<? if(!empty($working_method_data->updated_on)){echo date("d-m-Y h:i:s A" , strtotime($working_method_data->updated_on));}else{echo "-";}?></td>
										<td>
										<strong class="full">Updated By</strong>
										<? if(!empty($working_method_data->updated_by_name)){echo $working_method_data->updated_by_name;}else{echo "-";}?></td>
										<td >
										<strong class="full">Status</strong>
										<? if($working_method_data->status==1){ ?> Active <i class="fas fa-check btn-success btn-sm "></i>
