        ...
        <div class="row">
            <div class="col-12">
			    <div id="accordion">
                  ...
                  <div class="card card-primary">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse" style="">
                      <div class="card-body">
					  <form role="form" class="form-horizontal" name="search_report_form" id="search_report_form" action="<?php echo MAINSITE_Admin.$user_access->class_name.'/'.$user_access->function_name;?>" method="post" enctype="multipart/form-data">
						...
						<!-- <div class="row">
							<div class="col-md-6">
								...
								<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
									...
									<option value='urm.working_method_id' <? if($field_name=='urm.working_method_id'){echo 'selected';} ?>>working_method Name</option>
								</select>
                ...
                <div class="card">
					...
					?>
                    <div class="card-body">
                        <form action="<?php echo MAINSITE_Admin."$user_access->class_name/userworking_method-doUpdateStatus";?>"
                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <? } ?>
                                        <td><a href="<?=MAINSITE_Admin.$user_access->class_name."/working_method-view/".$urm->working_method_id?>"><?=$urm->working_method_id	?></a></td>
