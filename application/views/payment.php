                              ...
                              <h3 class="l-c-h3">
                                ...
                                <div class="l-c-div">
                                  ...
                                  <div class="l-c-phone"><div>
                                    ...
                                    <span class="l-c-phone-span">+91<?=$user->number?></span>
                                  </div>
                                </div>
                              </div>
                          ...
                          <div class="hide-div tab4_selection" style="display:none">
                            <h3 class="hide-div-heading">
                              ...
                              <span class="hide-div-span2">PAYMENT OPTIONS</span>
                                ...
                                <form action="<?=base_url().'pay-now'?>" onsubmit="myFunction()"  method="post">
                            <div class="hide-div-content1">
                            ...
                            <div class="hide-div-content1">
                              ...
                              <div class="hide-div-label1">
                                <label class="row ">
                                  ...
                                  <div class="col-lg-11 col-11">
                                    <div  class="hide-div-address-pay-options">
                                        <span >Cash on Delivery (<?=$currency->symbol?> <?=number_format($total + $ship_details->cod_charges)?>)</span>
                                    </div>
  ...
  url:"<?=base_url('pay-now')?>",
   ...
   success : function(result){
     ...
     $("#payNowBTN").html(text);
      if(result.status==1)
      {
         var easebuzzCheckout = new EasebuzzCheckout('<?=__PG_MERCHANT_KEY__?>', '<?=__PG_ENV__?>')
           var options = {
              ...
              $.ajax({
                ...
                url:'<?=base_url()?>order_confirmation',
                 ...
                 success : function(result){ //alert(result.status);
                   ...
                   if(result.status==1)
                   {
                  window.location = "<?=base_url().__orderStatus__?>";
                   }
                   else
                   {
                    window.location = "<?=base_url().__orderStatus__?>";
